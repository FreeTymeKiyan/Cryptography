...
def main():
    ...
    #message = 'ZAX IXREXL HM BRVP LCXJQXL HM AHIIP JHVZRQV JHBCHFVYL LQBQIRT ZH JRMMXQV RVY RTX FLXY ZH UTXN LZQBFIRZQVW AXTURI ZXRL'
    #message = 'MU KAZSYZA MUA LUAZ SOOZNYWUMSYZ QUMUA NSM PZ NUMOZAAZX UM SM *SLZAWNSM YQSM YU QSTZ S ERPVWN GNQUUV MSLZX SOYZA QWL. --*QZAPZAY *QUUTZA'
    message = 'KBJBT-KNVROH IVAANQTH, V TVTH XVTQHZW BS ZNH OHGIZBRH, VAAHVTI CJDH QR IDRJQONZ CDZ JBBYI ADTAJH DRMHT QRKVRMHIKHRZ JQONZ.'
